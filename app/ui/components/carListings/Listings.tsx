...
}: // listings,
{
	...
	const [listings, setListings] = useState<null | ListingRecord[]>(null);

	useEffect(() => {
		setIsLoading(true);
		const getListings = async () => {
			const { items: listingsResp } = await fetchListings(page, 6);
		...
		return (
			<section className="cars-section-four v1 layout-radius">
				<div className="DriverHUB-container">
					<div className="DriverHUB-title-three wow fadeInUp">
						<ul className="breadcrumb">
							<li>
								<Link href={`/`}>Acasa</Link>
							</li>
							<li>
								<span>Listă anunțuri</span>
							</li>
						</ul>
						...
						>
							...
							<div className="form_boxes">
								<a
									href="#"
									title=""
									className="filter-btn filter-popup"
								>
									<Image
										alt=""
