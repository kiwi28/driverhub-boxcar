				...
				<div className="row">
					...
					<div className="col-lg-6">
						...
						<div className="messages-box-el">
							...
							<div
								className="alert alert-error fade show"
								role="alert"
							>
					...
					<div className="col-xl-9">
						...
						<div className="box-button-el">
							...
							<a
								href="#"
								className="tf-btn primary-hover"
							>
							...
							<a
								href="#"
								className="tf-btn secondary-hover"
							>
