...
export const megaMenuData = [
	{
		...
		links: [
			{ href: "/listings", label: "Inventory List v1" },
	...
	},
	{
		...
		links: [
			{ href: "/listings/1", label: "Inventory Single v1" },
	...
	},
	{
		title: "Popular Makes",
		links: [
			{ href: "/listings/1", label: "Audi", inactive: true },
			{ href: "/listings/1", label: "BMW", inactive: true },
			{ href: "/listings/1", label: "Ford", inactive: true },
			{ href: "/listings/1", label: "Honda", inactive: true },
			{
				href: "/listings/1",
				label: "Land Rover",
				inactive: true,
	...
	},
	{
		title: "Type",
		links: [
			{ href: "/listings/1", label: "Sedan", inactive: true },
			{ href: "/listings/1", label: "SUVs", inactive: true },
			{
				href: "/listings/1",
				label: "Sport Coupe",
				inactive: true,
			...
			{ href: "/listings/1", label: "Wagon", inactive: true },
		],
	},
];
